...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self setBackgroundColor:WYAddMenuTableBackColor];
        
        UIView *selectView = [[UIView alloc] init];
        [selectView setBackgroundColor:WYAddMenuSelectColor];
...
- (void)setMenuItem:(WYAddMenuItem *)menuItem
{
    _menuItem = menuItem;
