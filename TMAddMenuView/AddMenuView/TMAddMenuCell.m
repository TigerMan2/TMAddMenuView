...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [self setBackgroundColor:TMAddMenuTableBackColor];
        
        UIView *selectView = [[UIView alloc] init];
        [selectView setBackgroundColor:TMAddMenuSelectColor];
...
- (void)setMenuItem:(TMAddMenuItem *)menuItem
{
    _menuItem = menuItem;
